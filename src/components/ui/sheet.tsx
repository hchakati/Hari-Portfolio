...
const sheetVariants = cva(
	"fixed z-50 gap-4 bg-background px-5  py-5 shadow-lg transition ease-[cubic-bezier(0.95,0.05,0.795,0.035)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-700",
	{
		variants: {
			side: {
