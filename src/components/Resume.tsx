...
export default function Resume() {
  return (
		<div id='resume' className="bg-black text-neutral-100 w-full h-full py-10 md:py-20">
			<div className=" container w-full h-full flex flex-col gap-8">
				<div className="flex flex-col md:flex-row w-full justify-between   bg-transparent">
					<h2 className="w-full md:w-1/3 text-[32px] md:text-[48px] font-bold">Experience</h2>
